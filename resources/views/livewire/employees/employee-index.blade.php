                    ...
                    <div class="row justify-content-xl-center">
                        <div class="col-12 col-xl-11">
                            ...
                            <div class="mb-4 mb-md-5">
                                ...
                                <address class="m-0 text-secondary">Seluruh data ini diakses oleh Kemenag Pusat secara
                                    <b>Real Time</b> <br> memakai URL API berikut :
                                </address>
                                <img src="{{ asset('cara_login.png') }}" alt="cara_login" class="img-fluid mt-2">
                            </div>
                            <div class="row mb-sm-4 mb-md-5 d-none">
